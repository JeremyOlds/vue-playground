...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      ...
      message: "Super secret message here! Assuming this will be appended on the end",
      //change isActive to true
      isActive: true,
      myName: 'had to add this in, im not sure if that was as designed or not, but oh well!'
    });
    return { state };
  },
};
